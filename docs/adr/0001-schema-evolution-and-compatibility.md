...
| Report-schema version | Normalized trust-report contract | `6.0.0` writable; `1.0.0` through `6.0.0` readable |
| Diff-schema version | Trust-diff output contract | `2.5.0` writable; `1.0.0` through `2.5.0` readable |
