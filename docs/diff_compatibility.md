...
Trust diff schema `2.4.0` compares only validated report documents. The library and CLI use the same `trustlab.compatibility.prepare_report_for_comparison` path for both inputs.
