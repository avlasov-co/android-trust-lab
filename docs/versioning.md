...
|---|---|---|
| Trust report schema | compatibility registry and versioned schemas | `5.0.0` writes; `1.0.0` through `5.0.0` read |
| Trust diff schema | compatibility registry and versioned schemas | `2.2.0` writes; `1.0.0` through `2.2.0` read |
