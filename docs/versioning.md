...
|---|---|---|
| Trust report schema | compatibility registry and versioned schemas | `4.0.0` writes; `1.0.0` through `4.0.0` read |
| Trust diff schema | compatibility registry and versioned schemas | `2.1.0` writes; `1.0.0`, `2.0.0`, and `2.1.0` read |
