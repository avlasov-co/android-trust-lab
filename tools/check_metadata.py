...
SCHEMA_IDS = {
    "app_probe_v1_0_0.schema.json": (f"{REPOSITORY_URL}/schema/app-probe/1.0.0"),
    "artifact_collection_manifest_v1_0_0.schema.json": (
        f"{REPOSITORY_URL}/schema/artifact-collection-manifest/1.0.0"
    ),
    ...
    "trust_diff_v2_2_0.schema.json": f"{REPOSITORY_URL}/schema/diff/2.2.0",
    ...
    "trust_diff_v2_7_0.schema.json": f"{REPOSITORY_URL}/schema/diff/2.7.0",
    "trust_diff_v2_8_0.schema.json": f"{REPOSITORY_URL}/schema/diff/2.8.0",
    ...
    "trust_report_v4_0_0.schema.json": f"{REPOSITORY_URL}/schema/report/4.0.0",
    "trust_report_v5_0_0.schema.json": f"{REPOSITORY_URL}/schema/report/5.0.0",
    "trust_report_v6_0_0.schema.json": f"{REPOSITORY_URL}/schema/report/6.0.0",
}
