...
- `collector_manifest_sample.json`: manually authored strict v1 portable manifest that integrity-binds the raw sample. This is not a normalized trust report.
